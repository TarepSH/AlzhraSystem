...
class AttendingsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create attending" do
    assert_difference('Attending.count') do
      post attendings_url, params: { attending: { day: @attending.day, students_id: @attending.students_id } }
    end
  ...
  test "should update attending" do
    patch attending_url(@attending), params: { attending: { day: @attending.day, students_id: @attending.students_id } }
