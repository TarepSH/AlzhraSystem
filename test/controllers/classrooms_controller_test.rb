...
class ClassroomsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create classroom" do
    assert_difference('Classroom.count') do
      post classrooms_url, params: { classroom: { book: @classroom.book, level: @classroom.level, name: @classroom.name, teacher_id: @classroom.teacher_id } }
    end
  ...
  test "should update classroom" do
    patch classroom_url(@classroom), params: { classroom: { book: @classroom.book, level: @classroom.level, name: @classroom.name, teacher_id: @classroom.teacher_id } }
