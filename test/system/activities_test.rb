...
class ActivitiesTest < ApplicationSystemTestCase
  ...
  test "creating a Activity" do
    ...
    fill_in "Activistdate", with: @activity.activistdate
    fill_in "Endingtime", with: @activity.endingtime
    fill_in "Place", with: @activity.place
    fill_in "Price", with: @activity.price
    fill_in "Startime", with: @activity.startime
    fill_in "Students", with: @activity.students_id
